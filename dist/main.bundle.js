...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_admin_admin_item_edit_admin_item_edit_component__ = __webpack_require__("./src/app/views/admin/admin-item-edit/admin-item-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_admin_admin_user_edit_admin_user_edit_component__ = __webpack_require__("./src/app/views/admin/admin-user-edit/admin-user-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_admin_admin_profile_admin_profile_component__ = __webpack_require__("./src/app/views/admin/admin-profile/admin-profile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_checkout_cart_cart_component__ = __webpack_require__("./src/app/views/checkout/cart/cart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_checkout_payment_payment_component__ = __webpack_require__("./src/app/views/checkout/payment/payment.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_checkout_summary_summary_component__ = __webpack_require__("./src/app/views/checkout/summary/summary.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__views_home_home_component__ = __webpack_require__("./src/app/views/home/home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__views_home_loggedin_home_loggedin_home_component__ = __webpack_require__("./src/app/views/home/loggedin-home/loggedin-home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__views_item_item_display_item_display_component__ = __webpack_require__("./src/app/views/item/item-display/item-display.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__views_item_item_edit_item_edit_component__ = __webpack_require__("./src/app/views/item/item-edit/item-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__views_item_item_list_item_list_component__ = __webpack_require__("./src/app/views/item/item-list/item-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__views_users_chooser_chooser_component__ = __webpack_require__("./src/app/views/users/chooser/chooser.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__views_users_creditcard_creditcard_component__ = __webpack_require__("./src/app/views/users/creditcard/creditcard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__views_users_login_login_component__ = __webpack_require__("./src/app/views/users/login/login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__views_users_profile_buyer_profile_buyer_profile_component__ = __webpack_require__("./src/app/views/users/profile/buyer-profile/buyer-profile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__views_users_profile_seller_profile_seller_profile_component__ = __webpack_require__("./src/app/views/users/profile/seller-profile/seller-profile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__views_users_profile_buyer_profile_order_history_order_history_component__ = __webpack_require__("./src/app/views/users/profile/buyer-profile/order-history/order-history.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__views_users_profile_seller_profile_sale_history_sale_history_component__ = __webpack_require__("./src/app/views/users/profile/seller-profile/sale-history/sale-history.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__views_users_register_register_component__ = __webpack_require__("./src/app/views/users/register/register.component.ts");
...
var appRoutes = [
    ...
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_7__views_home_home_component__["a" /* HomeComponent */] },
    { path: 'loggedinhome/users/:uid', component: __WEBPACK_IMPORTED_MODULE_8__views_home_loggedin_home_loggedin_home_component__["a" /* LoggedinHomeComponent */] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_14__views_users_login_login_component__["a" /* LoginComponent */] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_19__views_users_register_register_component__["a" /* RegisterComponent */] },
    { path: '', component: __WEBPACK_IMPORTED_MODULE_12__views_users_chooser_chooser_component__["a" /* ChooserComponent */] },
    { path: 'users/admin/:uid/edititem', component: __WEBPACK_IMPORTED_MODULE_1__views_admin_admin_item_edit_admin_item_edit_component__["a" /* AdminItemEditComponent */] },
    { path: 'users/admin/:uid/edituser', component: __WEBPACK_IMPORTED_MODULE_2__views_admin_admin_user_edit_admin_user_edit_component__["a" /* AdminUserEditComponent */] },
    { path: 'users/admin/:uid', component: __WEBPACK_IMPORTED_MODULE_3__views_admin_admin_profile_admin_profile_component__["a" /* AdminProfileComponent */] },
    { path: 'users/buyer/:uid', component: __WEBPACK_IMPORTED_MODULE_15__views_users_profile_buyer_profile_buyer_profile_component__["a" /* BuyerProfileComponent */] },
    { path: 'users/seller/:uid', component: __WEBPACK_IMPORTED_MODULE_16__views_users_profile_seller_profile_seller_profile_component__["a" /* SellerProfileComponent */] },
    { path: 'users/buyer/:uid/cart', component: __WEBPACK_IMPORTED_MODULE_4__views_checkout_cart_cart_component__["a" /* CartComponent */] },
    { path: 'users/buyer/:uid/payment', component: __WEBPACK_IMPORTED_MODULE_5__views_checkout_payment_payment_component__["a" /* PaymentComponent */] },
    { path: 'users/buyer/:uid/summary', component: __WEBPACK_IMPORTED_MODULE_6__views_checkout_summary_summary_component__["a" /* SummaryComponent */] },
    { path: 'users/buyer/:uid/history', component: __WEBPACK_IMPORTED_MODULE_17__views_users_profile_buyer_profile_order_history_order_history_component__["a" /* OrderHistoryComponent */] },
    { path: 'users/seller/:uid/history', component: __WEBPACK_IMPORTED_MODULE_18__views_users_profile_seller_profile_sale_history_sale_history_component__["a" /* SaleHistoryComponent */] },
    { path: 'users/buyer/:uid/creditcard', component: __WEBPACK_IMPORTED_MODULE_13__views_users_creditcard_creditcard_component__["a" /* CreditcardComponent */] },
    { path: 'users/seller/:uid/creditcard', component: __WEBPACK_IMPORTED_MODULE_13__views_users_creditcard_creditcard_component__["a" /* CreditcardComponent */] },
    { path: 'users/:uid/item/:iid', component: __WEBPACK_IMPORTED_MODULE_9__views_item_item_display_item_display_component__["a" /* ItemDisplayComponent */] },
    { path: 'users/guest/item/:iid', component: __WEBPACK_IMPORTED_MODULE_9__views_item_item_display_item_display_component__["a" /* ItemDisplayComponent */] },
    { path: 'users/seller/:uid/item/:iid', component: __WEBPACK_IMPORTED_MODULE_10__views_item_item_edit_item_edit_component__["a" /* ItemEditComponent */] },
    { path: 'users/seller/:uid/new', component: __WEBPACK_IMPORTED_MODULE_10__views_item_item_edit_item_edit_component__["a" /* ItemEditComponent */] },
    { path: 'users/:uid/searchresult', component: __WEBPACK_IMPORTED_MODULE_11__views_item_item_list_item_list_component__["a" /* ItemListComponent */] },
    { path: 'users/guest/searchresult', component: __WEBPACK_IMPORTED_MODULE_11__views_item_item_list_item_list_component__["a" /* ItemListComponent */] },
];
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.password !== this.verifiedPassword) {
            ...
            this.userService.register(this.username, this.password, this.userType).subscribe(function (data) {
                ...
                _this.router.navigate(['/user', _this.userType, data._id]);
            }, function (error) {
